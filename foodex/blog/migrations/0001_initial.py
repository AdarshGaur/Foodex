    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Required', max_length=200, unique=True, validators=[django.core.validators.RegexValidator('^[a-zA-Z0-9]+([-._][a-zA-Z0-9]+)*@[a-zA-Z0-9]+([-.][a-zA-Z0-9]+)*\\.[a-zA-Z]{2,7}$', 'Invalid Email Address')])),
                ...
                ('image_user', models.ImageField(default='default-avatar.png', upload_to=blog.models.user_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.recipe')),
